...
!macro CUSTOM_POSTINSTALL
  ...
  ; Manifest file path
  nsExec::ExecToLog 'cmd /c echo {"name":"app.ok200.native","description":"200 OK Web Server Native Messaging Host","path":"$INSTDIR\\ok200-host.exe","type":"stdio","allowed_origins":["chrome-extension://PLACEHOLDER_STABLE_ID/","chrome-extension://PLACEHOLDER_DEV_ID/"]} > "$LOCALAPPDATA\app.ok200.desktop\app.ok200.native.json"'
